...
{
	Super::BeginPlay();
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, TEXT("Inventory Character BeginPlay"));
...
{
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, TEXT("DropItem"));
...
void AInventoryCharacter::MoveForward(float AxisValue)
{
	...
	//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, FString::Printf(TEXT("MoveForward: %f"), AxisValue));	
}
void AInventoryCharacter::MoveRight(float AxisValue)
{
	AddMovementInput(GetActorRightVector(), AxisValue);
	//GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, FString::Printf(TEXT("MoveRight: %f"), AxisValue));
}
